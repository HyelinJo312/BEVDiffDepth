...
from bevdepth.projects import DINOLSSFPN
from bevdepth.layers.heads.dino_bev_depth_head import BEVDepthHead

__all__ = ['DINOBEVDepth']


class DINOBEVDepth(nn.Module):
    ...
    def __init__(self, backbone_conf, head_conf, is_train_depth=False, only_bev=True):
        super(DINOBEVDepth, self).__init__()
        self.backbone = DINOLSSFPN(**backbone_conf)

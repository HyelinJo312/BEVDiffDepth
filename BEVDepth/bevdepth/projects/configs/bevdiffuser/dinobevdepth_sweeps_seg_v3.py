"""
# diffusion_unet_v3_seg.py

[Updates]
- UNet dimension: 160 -> 320 -> 640 -> 640
- 
...
unet = dict(
    ...
    type='layout_diffusion.diffusion_unet_v3_seg.DiffusionUNetModel',
    parameters=dict(
        image_size=bev_h_,
        use_fp16=False,
        ...
        model_channels=bev_dim*2,  # 256 -> bev_dim*2
        context_dim=bev_dim*2,  
        seg_channels=[128, 256, 512],
...
data = dict(
    batch_size_per_device=1,
    train=dict(
        type='CustomNuScenesDiffusionDataset',
        data_root=data_root,

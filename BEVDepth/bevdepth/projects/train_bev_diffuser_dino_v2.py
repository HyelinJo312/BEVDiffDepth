        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(unet):
                ...
                with torch.no_grad():
                    ...
                    latents = bev_model(sweep_imgs, lidar_depth, mats, img_metas, only_bev=True, dino_out=dino_out).detach()
                ...
                if args.task_loss_scale > 0 and noise_scheduler.config.prediction_type == "sample":
                    task_loss = get_task_loss(model_pred, sweep_imgs, lidar_depth, mats, img_metas)
                else:
                    task_loss = 0
